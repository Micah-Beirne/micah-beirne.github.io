...
function createTopNav () {
    ...
    links.forEach(l => {
        ...
        a.style = '{float: left; display: block; color: white; text-align: center; padding: 14px; text-decoration: none;} :hover {background-color: pink; box-shadow: 0px 0px 10px black;}';
